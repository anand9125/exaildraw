        ...
        <div className="container mx-auto text-center">
          <div className="flex justify-around items-center mb-[200px] md:mb-[300px]">
            <div className="hover:scale-110 transition-all duration-300">
              <a
                href="https://x.com/AnandChaud65750"
                target="_blank"
            ...
            <div className="hover:scale-110 transition-all duration-300">
              <a
                href="https://www.linkedin.com/in/anand-chaudhary-b241b52a9/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-neutral-400 hover:text-white transition-colors cursor-pointer"
              >
            ...
            <div className="hover:scale-110 transition-all duration-300">
              <a
                href="mailto:achaudharyskn@gmail.com"
                className="text-neutral-400 hover:text-white transition-colors cursor-pointer"
              >
            ...
            <div className="hover:scale-110 transition-all duration-300">
              <a
                href="https://github.com/anand9125"
                target="_blank"
                rel="noopener noreferrer"
                className="text-neutral-400 hover:text-white transition-colors cursor-pointer"
              >
            ...
            <div className="hover:scale-110 transition-all duration-300">
              <a
                href="https://github.com/anand9125/exaildraw"
                target="_blank"
                rel="noopener noreferrer"
                className="text-neutral-400 hover:text-white transition-colors cursor-pointer"
              >
